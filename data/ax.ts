...
export const AX_CASE_STUDIES: AxCaseStudy[] = [
  ...
  },
  {
    ...
    intervention:
      '세 층으로 만들었습니다. ① 하네스 — Claude Code·Codex 작업 방식을 규칙·훅·에이전트·온디맨드 스킬로 묶어 코드 원칙·보안·배포 기준을 자동 주입했습니다. ② 루프 엔지니어링 — 완료를 자기보고가 아니라 독립 재검증으로 막는 완료 게이트(kdh), 가정을 먼저 노출하는 진화 루프(ooo), 매일 밤 부채를 자율 수정하는 무인 루프까지 실제로 돌립니다. ③ 기억 — 파일 기반 장기 기억과 의사결정 자동 회수 훅, 위키·문서 검색(RAG)으로 프로젝트 맥락을 다음 세션이 계속 회수합니다. 다만 트렌드를 그대로 따르지 않고, 전용 그래프 기억 도구는 har_eval로 측정한 뒤 "문서 기반으로 충분"하다고 판단해 만들지 않았습니다.',
    outcome:
  ...
  },
  {
    ...
    outcome:
      '진단의 낙인 위험을 기능 설계로 눌러, 개인은 본인 결과만 보고 팀은 역산이 불가능한 집계만 보는 협업 워크숍용 자가진단 SaaS로 운영 중입니다. 평가가 아니라 서로를 이해하는 톤이 닿아, "거울로 나를 들여다본 것 같다"는 사용자 피드백을 받았습니다.',
    disclosure: 'public',
    evidenceLabel: '프로젝트 상세',
  },
  {
