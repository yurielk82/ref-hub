...
export const PROJECTS: Project[] = [
  {
    ...
    description:
      '매출·수금·마진·흡수율 같은 제약 핵심 지표를 한눈에 보는 시각 대시보드가 없어, 상용 BI(Metabase/Superset)를 대체하려고 직접 만든 경영 KPI 대시보드. 도매·CSO 매출부터 흡수율·마진까지 시각화하고, 필요한 화면에서만 Claude·Gemini·GPT 인사이트를 호출합니다.',
    ...
    features: [
      '매출·수금·마진·흡수율을 시각 대시보드로 — 도매/CSO 매출, 제품별 실적, 전월·전년 대비 추이, 3M·6M·12M 흡수율',
      '마진·영업활동 전용 대시보드(KPI 캐시·5축 레이더)와 지역분포·Sankey·준수율 시각화',
      'AI 인사이트 — 월간 요약, ±20% 이상치 탐지, 자연어 질의(Claude·Gemini·GPT 3종, 스트리밍)',
      '필요한 화면에서만 AI를 호출하고 과거 월은 토큰 0 스냅샷으로 렌더해 보고 기준을 안정화',
      '관리자 콘솔에서 동기화 상태·데이터 기준월·DB 연결을 점검',
      'Metabase/Superset 같은 BI 도구를 대체하는 자체 시각 KPI 대시보드',
    ],
    highlight: '제약 핵심 지표 시각 KPI 대시보드 + 멀티 AI 인사이트',
    year: '2026',
  },
  {
    ...
    highlight: '전략기획 셀프서비스 데이터 기반 — ERP+13 API 통합',
    year: '2026',
    badge: 'NEW',
  },
  {
  ...
  },
  {
    ...
    features: [
      ...
      'Google OAuth 로그인, 관리자 view-as, 인쇄 최적화 PDF 출력',
    ],
  ...
  },
  {
    ...
    description:
      '영업팀이 업종 프로필(키워드·카테고리·필터)과 지역을 지정하면, 비동기 파이프라인이 검색 → 상세 → 리뷰·활동성 판정 → 노출·체인 분류 → 스코어링까지 단계별 병렬 처리해 등급화된 영업 타겟 DB와 엑셀을 출력합니다. 장시간 수집의 차단은 TLS 핑거프린트 위장과 동적 프록시 풀로 견딥니다.',
