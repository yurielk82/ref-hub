      ...
      <div className="mx-auto max-w-5xl">
        ...
        <FadeInUp delay={0.1}>
          ...
          <p className="mt-5 max-w-2xl text-base leading-relaxed text-stone-600 dark:text-stone-400">
            제약 도메인에 대한 이해를 바탕으로 복잡한 운영 이슈를 구조화하고,
            AI와 시스템을 활용해 실제로 작동하는 프로세스로 전환하는 일을
            하고 있습니다. 영업관리, 재고·생산·품질, 경영지원, 전산 협업 등
            다양한 직무를 거치며 조직 운영 전반을 경험했고, 반복과 비효율이
            발생하는 구조 자체를 개선하는 방식으로 성과를 만들어 왔습니다.
          </p>
        </FadeInUp>
