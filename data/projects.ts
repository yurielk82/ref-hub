...
export const PROJECTS: Project[] = [
  {
    ...
    features: [
      ...
      '엑셀 업로드, 업로드 이력, 템플릿 다운로드, DB 연결 상태 확인 등 운영자 데이터 관리',
  ...
  },
  {
    ...
    features: [
      ...
      'SIT 정산 엑셀 47개 컬럼을 업로드·매핑하고 CSO 업체명과 회원 사업자번호를 연결',
      'CSO 매칭 상태(normal/unregistered/pending/missing_match)와 무결성 검사로 조회 누락 원인 추적',
      '회원별 자사 정산 조회, 월별 수수료 합계, 표시 컬럼 기반 엑셀 내보내기',
  ...
  },
  {
    ...
    features: [
      '갑지·을지 엑셀 업로드와 파일명 날짜 추출 후 공급구분별 탭으로 데이터 자동 분류',
      ...
      '최종 규칙 1회 적용 후 KPIS 포털용 갑지·을지 파일 생성 또는 MA111~MA114 API 자동 제출',
    ],
  ...
  },
  {
    ...
    features: [
      ...
      '확률 플롯, 욕조 곡선, 신뢰도/CDF, 시계열, 히트맵을 PNG/PDF/SVG로 생성',
  ...
  },
  {
    ...
    features: [
      'Claude Code 규칙 22개를 계층화해 코드 원칙, 보안, DDD, 디자인, 배포 기준을 자동 주입',
      ...
      'AI 페어 프로그래밍을 개인 프롬프트가 아니라 재사용 가능한 운영 하네스로 표준화',
      '작업 완료 후 검증·커밋·push·배포 흐름까지 규칙화해 개발 생산성과 안전성을 함께 강화',
    ],
