...
export const AX_CASE_STUDIES: AxCaseStudy[] = [
  ...
  },
  {
    ...
    problem:
      '회사 ERP가 내보내는 데이터로는 법정 의약품 공급내역보고를 그대로 제출할 수 없었고, 전산팀조차 해결할 수 없다고 한 문제였습니다. 그래서 매번 엑셀 수식으로 보고서를 손수 만들었고, 매일 적지 않은 업무시간이 이 반복 작업에 사라졌습니다.',
    intervention:
      '이 엑셀 수작업을 단계적으로 시스템으로 옮겼습니다. 처음에는 스프레드시트에 복사·붙여넣기만 하면 되도록 반자동화했고, 지금은 표준코드·규격, 그리고 거기서 파생되는 수량·단가 오류까지 의약품관리종합정보센터(KPIS) API 조회로 모두 자동 검수·교정해 무결한 공급내역보고를 산출합니다. 마지막으로 신고 API까지 연결해, 사람이 최종 확인만 하면 자동 보고되는 직전 단계까지 구현했습니다.',
    outcome:
      '전산팀이 포기했던 문제를, 매일 시간을 잡아먹던 엑셀 수작업에서 → 오류를 스스로 검증하는 무결 보고서 자동 산출로 바꾸고, 자동 신고 직전 단계까지 끌어왔습니다.',
    disclosure: 'withheld',
    evidenceLabel: '프로젝트 상세',
  },
  {
