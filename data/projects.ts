...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    description:
      '협업 성향을 Big Five(IPIP)·사티어 의사소통 5유형·Vaillant 방어기제 세 배터리(자체 문항·Likert)로 측정해 개인 아키타입·AI 해석·팀 집계를 내는 자가진단 도구. HR 평가가 아니라 대면 협업 워크숍 참고용으로, 낙인 방지를 설계 단계부터 박았습니다.',
    ...
    highlight: '팀 협업 스타일 3축 진단 — 낙인 방지 설계 + RLS',
    year: '2026',
    badge: 'NEW',
  },
  {
