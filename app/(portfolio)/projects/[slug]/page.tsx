  ...
  return (
    <article className="px-6 pb-28 pt-12">
      <div className="mx-auto max-w-3xl">
        ...
        <Link
          href="/"
          className="mb-8 inline-flex items-center gap-1.5 text-sm text-stone-500 transition-colors hover:text-[var(--accent)]"
        >
        ...
        <div className="mt-8">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="font-[family-name:var(--font-display)] text-2xl font-bold text-stone-900 sm:text-3xl dark:text-stone-50">
                {project.name}
              </h1>
              <p className="text-sm text-stone-500">{project.tagline}</p>
            </div>
          </div>
          ...
          {/* 기술 스택 */}
          <div className="mt-8">
            <p className="mb-3 font-[family-name:var(--font-mono)] text-xs uppercase tracking-wider text-stone-500">
              기술 스택
            </p>
