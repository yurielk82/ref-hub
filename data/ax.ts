...
export const AX_CASE_STUDIES: AxCaseStudy[] = [
  ...
  },
  {
    ...
    outcome:
      '사진 한 장씩 눈으로 보던 매달 15일짜리 수작업을, 4단계 위변조 방어가 1차로 걸러내고 사람은 의심 건만 검수하는 증거 기반 워크플로우로 재설계했습니다. 이 검증은 자료검토·자동 정산서·조회/발송(메일머지)·필터링으로 이뤄진 시스템의 일부이며, 업계 상용 프로그램과 같은 수준에 이르러 회사가 상용 도입을 결정하면서 그 개발 파트너로 기능을 함께 만들고 있습니다.',
    disclosure: 'range',
    evidenceLabel: '프로젝트 상세',
  },
  {
