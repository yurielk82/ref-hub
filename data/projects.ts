...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    category: 'tool',
    liveUrl: 'https://ev-motor-reliability.vercel.app',
  ...
  },
  {
    slug: 'corerx',
    name: 'CoreRx',
    tagline: '제약사 매출 KPI 대시보드 (ETL + BI)',
    description:
      '다수 제약사의 매출 데이터를 통합 수집·가공하여 KPI 대시보드로 시각화하는 BI 시스템. ETL 파이프라인으로 데이터를 정제하고 Apache Superset으로 인터랙티브 분석을 제공합니다.',
    tech: ['Python 3.11', 'PostgreSQL', 'Apache Superset', 'Docker'],
    category: 'tool',
    docsPath: '/corerx',
    screenshot: '',
    emoji: '💊',
    ...
    features: [
      '다수 제약사 매출 데이터 ETL 파이프라인',
      '경영진 요약 대시보드',
      '시장 인텔리전스 분석',
      '영역·거래처별 성과 추적',
    ],
    highlight: 'Python ETL + Superset BI 통합',
    year: '2025',
  },
]
