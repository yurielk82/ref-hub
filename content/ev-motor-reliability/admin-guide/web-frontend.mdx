...
프로덕션 환경에서는 workspace systemd 서비스로 실행합니다.

```bash
cd /home/ubuntu/GitHub
./bin/deploy.sh ev-motor-reliability
systemctl status github-ev-motor-api.service
journalctl -u github-ev-motor-api.service -n 50 --no-pager
```
