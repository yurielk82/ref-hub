...
export function PortfolioNav() {
  ...
  return (
    <header className="fixed top-0 z-50 w-full border-b border-transparent bg-white/70 backdrop-blur-xl dark:bg-stone-950/70" style={{ borderColor: 'var(--glass-border)' }}>
      <nav className="mx-auto flex h-14 max-w-5xl items-center justify-between px-6">
        <Link href="/" className="font-[family-name:var(--font-display)] text-sm font-bold tracking-tight text-stone-900 dark:text-stone-100">
          Ref Hub
        </Link>
