...
export const PROJECTS: Project[] = [
  {
    ...
    features: [
      'ERP 데이터를 우리 DB에 스냅샷으로 떠 그 위에서 KPI를 즉시 조회 — 매번 ERP를 직접 뒤지지 않아 빠름',
      'PMI 때 들은 경영진 일·주·월 보고 주기를 자체 BI 툴에 녹임',
      '매출·수금·마진·흡수율 시각화 — 도매/CSO 매출, 제품별 실적, 전월·전년 대비 추이, 3M·6M·12M 흡수율',
      '마진·영업활동 전용 대시보드(KPI 캐시·5축 레이더)와 지역분포·Sankey·준수율 시각화',
      'AI 인사이트 — 월간 요약, ±20% 이상치 탐지, 자연어 질의(Claude·Gemini·GPT 3종, 스트리밍)',
      '한국 법령 MCP 연동 — 약사법·고시 질의에 AI가 실제 법령 원문·사례만 인용하도록 묶어 환각 차단(하네스 엔지니어링)',
      '필요한 화면에서만 AI 호출, 과거 월은 토큰 0 스냅샷으로 렌더해 비용 규율',
