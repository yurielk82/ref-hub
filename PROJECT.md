...
- 2026-04: Vercel → OCI 자체 호스팅 + Nginx 마이그레이션 + 히어로 제거(v1.4.0) # WHY: Vercel 무료 티어 제약 회피
- 2026-04: systemd 서비스 + pmx 명령 통합 # WHY: 워크스페이스 공통 배포 표준 정렬
...
- Nginx (ref.dvsharp.com) + systemd (포트 3007)
- Vercel에서 OCI systemd로 이관 완료 (2026-04)
